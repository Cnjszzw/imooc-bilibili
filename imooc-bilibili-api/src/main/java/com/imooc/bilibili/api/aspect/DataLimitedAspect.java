    ...
    public void doBefore(JoinPoint joinPoint){
        ...
        for(Object arg : args){
          if(arg instanceof UserMoment){
              ...
              //等级为1和等级为0的用户只能发布type1或者0的动态
              if((roleCodeSet.contains(AuthRoleConstant.ROLE_LV0) || roleCodeSet.contains(AuthRoleConstant.ROLE_LV1))  && (!"0".equals(type) && !"1".equals(type))){
